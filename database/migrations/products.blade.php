					    ...
					    <select class="form-control" name="category" id="category" >
					        ...
					        <optgroup label="Догляд за волоссям">
									...
									<optgroup label="Креми та маски">
											<option value="Гелі для душу">Креми для обличчя та рук</option>
										  <option value="Гліцеринове мило">Маски для обличчя</option>
										  <option value="Рослинне мило">Вазелін</option>
									</optgroup>
